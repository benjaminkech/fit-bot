...
export class AppComponent implements OnInit, OnDestroy {
  ...
  get date(): AbstractControl | null { return this.form.get('date'); }
  get course(): AbstractControl | null  { return this.form.get('course'); }
  ...
  onSubmit(): void {
    ...
    this.courseService.postTrigger(body).subscribe(data => {
